...
/*Problem 3 Solution*/
MATCH (n:Person {name: "Lauren Holiday"}) RETURN n:dob AS DateOfBirth
...
/*Problem 6 Solution*/
MATCH (p:Person)-[:REPRESENTS]->(t:Team {name: "USA"})-[:SCORED_GOAL]->(m.Match) RETURN p:name
...
/*Problem 9 Solution*/
MATCH (p:Person)-[:REPRESENTS]->(t:Team {name: "USA"})-[r:COACH_FOR]->(b:Squad) RETURN p:name
